; ModuleID = 'input-instrumented.bc'
...
@0 = internal constant i32 280265408
@1 = internal constant i32 280265920
@2 = internal constant i32 280265408
@3 = internal constant i32 280265920
@4 = internal constant i32 280265408
@5 = internal constant i32 280265920
@6 = internal constant i32 280265408
@7 = internal constant i32 280265920

; Function Attrs: uwtable
define internal void @__cxx_global_var_init() #0 section ".text.startup" {
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* @_ZStL8__ioinit)
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i32 0, i32 0), i8* @__dso_handle) #2
  call void @updateInstrInfo(i32 2, i32* @0, i32* @1)
...
define i32 @_Z1fi(i32) #3 {
  ...
  %4 = add nsw i32 %3, 5
  call void @updateInstrInfo(i32 5, i32* @2, i32* @3)
  call void @printOutInstrInfo()
  ret i32 %4
}
...
define i32 @main() #4 {
  ...
  call void @updateInstrInfo(i32 6, i32* @4, i32* @5)
  call void @printOutInstrInfo()
  ret i32 0
}
...
define internal void @_GLOBAL__sub_I_input.cpp() #0 section ".text.startup" {
  ...
  call void @updateInstrInfo(i32 2, i32* @6, i32* @7)
  call void @printOutInstrInfo()
  ret void
}
